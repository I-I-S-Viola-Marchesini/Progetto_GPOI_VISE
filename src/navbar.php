...
<div class="offcanvas rounded-3 m-3 offcanvas-end bg-transparent border-0" style="max-width: 75vw;" tabindex="-1" id="offcanvas_account_mng">
    <div class="offcanvas-header bg-white rounded-5">
        <h5 class="offcanvas-title">Accedi a Vise</h5>
    ...
    <div class="offcanvas-body bg-white rounded-5">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <h3>Non hai effettuato l'accesso</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="list-group list-group-flush">
                    ...
                    <a href="?page=login" class="list-group-item list-group-item-action rounded-3 d-flex align-items-center">
                    ...
                    <a href="?page=signup" class="list-group-item list-group-item-action rounded-3 d-flex align-items-center">
...
<div class="offcanvas rounded-3 m-3 offcanvas-end bg-transparent border-0" style="max-width: 90vw;" tabindex="-1" id="offcanvas_notifications">
    <div class="offcanvas-header bg-white rounded-5">
